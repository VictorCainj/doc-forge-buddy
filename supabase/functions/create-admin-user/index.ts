/**
 * @fileoverview Supabase Edge Function para criação de usuário administrador
 * @description Função serverless para criar usuários admin com privilégios elevados
 * @version 1.0.0
