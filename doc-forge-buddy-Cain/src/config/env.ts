...
const envSchema = z.object({
  ...
  // Alerting and Monitoring (opcional)
  VITE_SLACK_WEBHOOK_URL: z.string().url().optional(),
  VITE_ALERT_WEBHOOK_URL: z.string().url().optional(),
  VITE_TEAMS_WEBHOOK_URL: z.string().url().optional(),
  VITE_EMAIL_ALERT_ENABLED: z.boolean().optional(),
  VITE_EMAIL_ALERT_TO: z.string().email().optional(),
