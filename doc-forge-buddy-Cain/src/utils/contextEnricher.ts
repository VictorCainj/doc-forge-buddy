 ...
 */
const extractRelevantInfoFromMessage = (message: string, _formData: unknown) => {
 ...
 */
const extractRentValue = (formData: unknown): string | undefined => {
  ...
  // Type guard para verificar se formData é um objeto
 ...
 */
const extractDepositValue = (formData: unknown): string | undefined => {
