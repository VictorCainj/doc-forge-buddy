...
class SecurityScanner {
  ...
  private async scanNpmAudit(): Promise<Vulnerability[]> {
    try {
  ...
  private async scanOutdated(): Promise<OutdatedPackage[]> {
    try {
  ...
  private async scanLicenses(): Promise<LicenseIssue[]> {
    try {
  ...
  generateSummary(report: SecurityReport): string {
...
`;
  ...
  private getRiskLevel(critical: number, high: number): string {
...
async function main() {
  ...
  console.log(scanner.generateSummary(report));
