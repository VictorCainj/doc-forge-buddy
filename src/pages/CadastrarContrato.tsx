...
import { Users, FileText, Plus, ArrowLeft, Shield } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div>
                ...
                <p className="text-white/80 text-lg">
                  Preencha as informações essenciais para criar um novo contrato
                  no sistema
                </p>
              </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="text-right text-white/90">
                <p className="text-sm">Sistema de Gestão de Contratos</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Informações essenciais como número, endereço e datas
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Qualificação completa de locadores e locatários
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Geração automática de notificações e devolutivas
                    </p>
                  </div>
                </div>
              </div>
