    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center space-x-2">
          ...
          <span>{editingApontamento ? 'Editar Apontamento' : 'Novo Apontamento'}</span>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => onCurrentChange({ ...currentApontamento, ambiente: e.target.value })}
          />
        </div>
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => onCurrentChange({ ...currentApontamento, subtitulo: e.target.value })}
          />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => 
                  onCurrentChange({ ...currentApontamento, quantidade: parseFloat(e.target.value) || 0 })
                }
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => 
                  onCurrentChange({ ...currentApontamento, valor: parseFloat(e.target.value) || 0 })
                }
              />
            </div>
          </div>
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={(e) => onCurrentChange({ ...currentApontamento, observacao: e.target.value })}
            rows={2}
          />
        </div>
