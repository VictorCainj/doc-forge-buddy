...
export type ContractAction =
  ...
  // Form Data
  | { type: 'SET_FORM_DATA'; payload: { key: keyof ContractState['formData']; value: any } }
  | { type: 'RESET_FORM_DATA' }
  
  // Loading
  | { type: 'SET_LOADING'; payload: { key: keyof ContractState['loading']; value: any } }
...
export function useContractReducer() {
  ...
  const actions = {
    ...
    // Form Data
    setFormData: (key: keyof ContractState['formData'], value: any) => 
