    ...
    <>
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select 
                ...
                onValueChange={(value) => onFormDataChange('tipoVistoria', value)}
              >
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => onFormDataChange('dataVistoria', e.target.value)}
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => onFormDataChange('horaVistoria', e.target.value)}
                className="col-span-3"
                required
              />
            </div>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onCloseModal('agendamento')}>
              Cancelar
            </Button>
            <Button onClick={onGenerateAgendamento}>
              Gerar Notificação
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Preencha a data da vistoria/revistoria e selecione quem vai assinar o documento.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) => onFormDataChange('tipoVistoriaRecusa', value)}
              >
                <SelectTrigger className="col-span-3">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                onChange={(e) => onFormDataChange('dataRealizacaoVistoria', e.target.value)}
                className="col-span-3"
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) => onFormDataChange('assinanteSelecionado', value)}
              >
                <SelectTrigger className="col-span-3">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onCloseModal('recusaAssinatura')}>
              Cancelar
            </Button>
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onCloseModal('statusVistoria')}>
              Cancelar
            </Button>
            <Button 
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Selecione para qual{' '}
              {formData.whatsAppType === 'locador' ? 'locador' : 'locatário'} você deseja
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select 
                ...
                onValueChange={(value) => onFormDataChange('selectedPerson', value)}
              >
                <SelectTrigger className="col-span-3">
                  <SelectValue
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onCloseModal('whatsapp')}>
              Cancelar
            </Button>
            <Button
              onClick={onGenerateWhatsApp}
              disabled={!formData.selectedPerson || !formData.assinanteSelecionado}
            >
              Gerar WhatsApp
            </Button>
          </DialogFooter>
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => onCloseModal('assinante')}>
              Cancelar
            </Button>
            <Button
