...
export const GradientLayout = ({ children, className = '' }: GradientLayoutProps) => {
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden ${className}`}>
      {/* Background Pattern */}
