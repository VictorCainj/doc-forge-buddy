...
const createColorPattern = (prefix) => {
  ...
  return new RegExp(
    `${prefix}-(${forbiddenColorsPattern})-(\\d{2,3}|50|950)`,
    'g'
  );
};
...
function printReport() {
  ...
  console.log(
    '║   AUDITORIA DE CORES - GOOGLE MATERIAL DESIGN 3             ║'
  );
  console.log(
    '╚══════════════════════════════════════════════════════════════╝\n'
  );
  ...
  if (totalIssues === 0) {
    console.log(
      '✅ Nenhuma cor não-Material encontrada! Projeto 100% em conformidade.\n'
    );
    return;
  }
  ...
  console.log(
    '║   MAPEAMENTO DE CORES MATERIAL DESIGN                        ║'
  );
  console.log(
    '╚══════════════════════════════════════════════════════════════╝\n'
  );
